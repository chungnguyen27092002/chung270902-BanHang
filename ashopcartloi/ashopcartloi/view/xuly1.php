...
$sql = "SELECT * FROM tbl_admin WHERE TaiKhoan = '$TaiKhoan' OR email = '$email'";
...
$sql = "INSERT INTO tbl_admin (TaiKhoan, MatKhau, email, Sodienthoai) VALUES ('$TaiKhoan','$MatKhau','$email','$Sodienthoai')";

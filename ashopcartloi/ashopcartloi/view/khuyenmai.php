<div class="row mb ">
            ...
            <div class="boxphai">
                ...
                <div class="row mb">
                    <div class="boxtitle">Đồng hồ nam</div>
                    <div class="boxcontent2 menudoc">
                   
                        <ul>
                            <li>
                                <a href="#">Đồng hồ nam Omega</a>
                            </li>
                            <li>
                                <a href="#">Đồng hồ nam DiamonD</a>
                            </li>
                            <li>
                                <a href="#">Đồng hồ nam Casio</a>
                            </li>
                            <li>
                                <a href="#">Đồng hồ name Longines</a>
                            </li>
                            <li>
                                <a href="#">Đồng hồ nam Tissot</a>
                            </li>
                            <li>
                                <a href="#">Đồng hồ nam Ticizen</a>
                            </li>
                            <li>
                                <a href="#">Đồng hồ nam Aries Gold</a>
                            </li>

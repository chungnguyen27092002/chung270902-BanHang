                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="http://localhost/ashopcartloi/ashopcartloi/product.php">Sản phẩm</a>
                            </li>
                            <li>
                                <a href="http://localhost/ashopcartloi/ashopcartloi/category.php">Loại Sản Phẩm</a>
                            </li>
                            <li>
                                <a href="http://localhost/ashopcartloi/ashopcartloi/phukien2.php">Mặt Nạ</a>
                            </li>
                            <!-- <li>
                            <a href="http://localhost/ashopcartloi/controller/index.php?act=trangchu">Trang Chủ User</a>
                            </li>                    -->
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        ...
                        <li>
                            <a href="http://localhost/ashopcartloi/ashopcartloi/view/login.php">

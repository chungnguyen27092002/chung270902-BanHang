...
<head>
    ...
    <div class="container">
        ...
        <a class="btn btn-info" href="index.php?module=product&action=new">Thêm sản phẩm</a>
        <br>
        <br>
        <table class="table table-dark">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?module=product&action=edit&id=<?php echo $row['id']; ?>">Sửa</a> |
                        <a href="index.php?module=product&action=delete&id=<?php echo $row['id']; ?>
